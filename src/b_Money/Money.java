...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		int amountInThisCurrency = this.currency.valueInThisCurrency(other.amount, other.currency);
		return new Money(this.amount + amountInThisCurrency, this.currency);
	}
	...
	public int compareTo(Object other) {
		...
		int thisValue = this.universalValue();
		int otherValue = otherMoney.universalValue();
